...
rtl.module("WebCtrlsMore",["System","Classes","Types","Graphics","Controls","ExtCtrls","Forms"],function () {
  "use strict";
  var $mod = this;
...
rtl.module("Unit1",["System","SysUtils","Classes","Controls","Forms","WebCtrls","WebCtrlsMore"],function () {
  ...
  rtl.createClass(this,"TForm1",pas.Forms.TForm,function () {
    ...
    this.FormKeyPress = function (Sender, Key) {
      ...
      if (($tmp >= "0") && ($tmp <= "9")) {
        ...
        $impl.CAdd()}
       else if ($tmp === String.fromCharCode(13)) {
        $impl.CEqual()}
       else {
        $impl.ErrorInput();
      };
    ...
    $r.addField("Button12",pas.WebCtrls.$rtti["TButton"]);
    $r.addField("Button13",pas.WebCtrls.$rtti["TButton"]);
    $r.addField("Button14",pas.WebCtrls.$rtti["TButton"]);
    $r.addField("Button15",pas.WebCtrls.$rtti["TButton"]);
    $r.addField("Button16",pas.WebCtrls.$rtti["TButton"]);
    $r.addField("HiddenButton",pas.WebCtrls.$rtti["TButton"]);
    ...
    $r.addMethod("Button12Click",0,[["Sender",pas.System.$rtti["TObject"]]]);
    $r.addMethod("Button13Click",0,[["Sender",pas.System.$rtti["TObject"]]]);
    $r.addMethod("Button14Click",0,[["Sender",pas.System.$rtti["TObject"]]]);
    $r.addMethod("Button15Click",0,[["Sender",pas.System.$rtti["TObject"]]]);
    $r.addMethod("Button16Click",0,[["Sender",pas.System.$rtti["TObject"]]]);
    $r.addMethod("FormCreate",0,[["Sender",pas.System.$rtti["TObject"]]]);
    $r.addMethod("Edit1MouseDown",0,[["Sender",pas.System.$rtti["TObject"]],["Button",pas.Controls.$rtti["TMouseButton"]],["Shift",pas.Controls.$rtti["TShiftState"]],["X",rtl.nativeint],["Y",rtl.nativeint]]);
    $r.addMethod("FormKeyDown",0,[["Sender",pas.System.$rtti["TObject"]],["Key",rtl.nativeint,1],["Shift",pas.Controls.$rtti["TShiftState"]]]);
    $r.addMethod("HiddenButtonClick",0,[["Sender",pas.System.$rtti["TObject"]]]);
  ...
  $mod.$implcode = function () {
    ...
    $impl.Computes = function (Oper) {
      ...
      if ((StackOper !== 0) && (!$impl.CalcContext.EqualDone || (Oper === 5))) {
        IsOverflow = false;
        var $tmp = StackOper;
        if ($tmp === 1) {
          if (NumVal === 0) {
          ...
          $impl.CalcContext.CurNumVal = rtl.trunc(StackVal / NumVal);
        } else if ($tmp === 2) {
    ...
    $impl.IsMulOverflow = function (Val1, Val2, Res) {
      ...
      if ((Val1 === 0) || (Val2 === 0)) {
        ...
        Result = Math.abs(Val1) > rtl.trunc(9007199254740991 / Math.abs(Val2));
        if (!Result) {
          Res.set(Val1 * Val2);
    ...
    $impl.CRemDigit = function () {
      ...
      if ($impl.CalcContext.EqualDone) $impl.Empties();
      $impl.CalcContext.IsError = false;
      $impl.CalcContext.CurNumVal = rtl.trunc(NumVal / 10);
      $impl.DisplayNumVal();
    };
...
rtl.module("u1",["System","Classes","Controls","Forms","WebCtrls","WebCtrlsMore"],function () {
  "use strict";
  var $mod = this;
  this.Loaded = function () {
    ...
    $with.Edit1.SetLeft(7);
    $with.Edit1.SetHeight(21);
    $with.Edit1.SetTop(7);
    $with.Edit1.SetWidth(193);
    $with.Edit1.SetAlignment(1);
    $with.Edit1.FOnMouseDown = rtl.createCallback($with,"Edit1MouseDown");
    $with.Edit1.SetReadOnly(true);
    ...
    $with.Button1.SetLeft(10);
    $with.Button1.SetHeight(32);
    $with.Button1.SetTop(120);
    $with.Button1.SetWidth(40);
    $with.Button1.SetText("1");
    ...
    $with.Button2.SetLeft(58);
    $with.Button2.SetHeight(32);
    $with.Button2.SetTop(120);
    $with.Button2.SetWidth(40);
    $with.Button2.SetText("2");
    ...
    $with.Button3.SetLeft(106);
    $with.Button3.SetHeight(32);
    $with.Button3.SetTop(120);
    $with.Button3.SetWidth(40);
    $with.Button3.SetText("3");
    ...
    $with.Button4.SetLeft(10);
    $with.Button4.SetHeight(32);
    $with.Button4.SetTop(80);
    $with.Button4.SetWidth(40);
    $with.Button4.SetText("4");
    ...
    $with.Button5.SetLeft(58);
    $with.Button5.SetHeight(32);
    $with.Button5.SetTop(80);
    $with.Button5.SetWidth(40);
    $with.Button5.SetText("5");
    ...
    $with.Button6.SetLeft(106);
    $with.Button6.SetHeight(32);
    $with.Button6.SetTop(80);
    $with.Button6.SetWidth(40);
    $with.Button6.SetText("6");
    ...
    $with.Button7.SetLeft(10);
    $with.Button7.SetHeight(32);
    $with.Button7.SetTop(40);
    $with.Button7.SetWidth(40);
    $with.Button7.SetText("7");
    ...
    $with.Button8.SetLeft(58);
    $with.Button8.SetHeight(32);
    $with.Button8.SetTop(40);
    $with.Button8.SetWidth(40);
    $with.Button8.SetText("8");
    ...
    $with.Button9.SetLeft(106);
    $with.Button9.SetHeight(32);
    $with.Button9.SetTop(40);
    $with.Button9.SetWidth(40);
    $with.Button9.SetText("9");
    ...
    $with.Button10.SetLeft(10);
    $with.Button10.SetHeight(32);
    $with.Button10.SetTop(160);
    $with.Button10.SetWidth(40);
    $with.Button10.SetText("0");
    ...
    $with.Button11.SetLeft(58);
    $with.Button11.SetHeight(32);
    $with.Button11.SetTop(160);
    $with.Button11.SetWidth(40);
    $with.Button11.SetText("C");
    $with.Button11.FOnClick = rtl.createCallback($with,"Button11Click");
    $with.Button11.EndUpdate();
    $with.Button12 = pas.WebCtrls.TButton.$create("Create$1",[pas.Unit1.Form1]);
    $with.Button12.BeginUpdate();
    $with.Button12.SetParent(pas.Unit1.Form1);
    $with.Button12.SetLeft(106);
    $with.Button12.SetHeight(32);
    $with.Button12.SetTop(160);
    $with.Button12.SetWidth(40);
    $with.Button12.SetText("=");
    $with.Button12.FOnClick = rtl.createCallback($with,"Button12Click");
    $with.Button12.EndUpdate();
    $with.Button13 = pas.WebCtrls.TButton.$create("Create$1",[pas.Unit1.Form1]);
    $with.Button13.BeginUpdate();
    $with.Button13.SetParent(pas.Unit1.Form1);
    $with.Button13.SetLeft(154);
    $with.Button13.SetHeight(32);
    $with.Button13.SetTop(40);
    $with.Button13.SetWidth(40);
    $with.Button13.SetText("\/");
    $with.Button13.FOnClick = rtl.createCallback($with,"Button13Click");
    $with.Button13.EndUpdate();
    $with.Button14 = pas.WebCtrls.TButton.$create("Create$1",[pas.Unit1.Form1]);
    $with.Button14.BeginUpdate();
    $with.Button14.SetParent(pas.Unit1.Form1);
    $with.Button14.SetLeft(154);
    $with.Button14.SetHeight(32);
    $with.Button14.SetTop(80);
    $with.Button14.SetWidth(40);
    $with.Button14.SetText("*");
    $with.Button14.FOnClick = rtl.createCallback($with,"Button14Click");
    $with.Button14.EndUpdate();
    $with.Button15 = pas.WebCtrls.TButton.$create("Create$1",[pas.Unit1.Form1]);
    $with.Button15.BeginUpdate();
    $with.Button15.SetParent(pas.Unit1.Form1);
    $with.Button15.SetLeft(154);
    $with.Button15.SetHeight(32);
    $with.Button15.SetTop(120);
    $with.Button15.SetWidth(40);
    $with.Button15.SetText("-");
    $with.Button15.FOnClick = rtl.createCallback($with,"Button15Click");
    $with.Button15.EndUpdate();
    $with.Button16 = pas.WebCtrls.TButton.$create("Create$1",[pas.Unit1.Form1]);
    $with.Button16.BeginUpdate();
    $with.Button16.SetParent(pas.Unit1.Form1);
    $with.Button16.SetLeft(154);
    $with.Button16.SetHeight(32);
    $with.Button16.SetTop(160);
    $with.Button16.SetWidth(40);
    $with.Button16.SetText("+");
    $with.Button16.FOnClick = rtl.createCallback($with,"Button16Click");
    $with.Button16.EndUpdate();
    $with.HiddenButton = pas.WebCtrls.TButton.$create("Create$1",[pas.Unit1.Form1]);
    $with.HiddenButton.BeginUpdate();
    $with.HiddenButton.SetParent(pas.Unit1.Form1);
    $with.HiddenButton.SetVisible(false);
    $with.HiddenButton.SetText("Hidden Focus");
    $with.HiddenButton.SetDefault(true);
    $with.HiddenButton.FOnClick = rtl.createCallback($with,"HiddenButtonClick");
    $with.HiddenButton.EndUpdate();
    pas.Unit1.Form1.EndUpdate();
    pas.Unit1.Form1.EndUpdate();
    pas.Unit1.Form1.FormCreate(null);
  };
},["Unit1"]);
rtl.module("program",["System","Unit1","u1","WebCtrls","Forms"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
